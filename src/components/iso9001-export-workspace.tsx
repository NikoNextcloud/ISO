...
export function Iso9001ExportWorkspace() {
  return <IsoExportWorkspace config={{
    ...
    fields: [
      ...
      { key: "preparedBy", hint: "реалният отговорник по СУК/поддръжката; ако липсва, се използва „Отговорник поддръжка“" },
      { key: "foundedAt", required: true, hint: "единна дата за всички документи" },
      { key: "effectiveDate", required: true },
      { key: "version", required: true },
      { key: "activity", required: true, hint: "реалната основна дейност, не целият правен предмет от Търговския регистър" },
      ...
      { key: "designDevelopment", required: true, hint: "изберете „Не е приложимо“, ако фирмата работи само по утвърдени изисквания и не разработва нови продукти/услуги" },
